...
class FreshSwipe extends StatefulWidget {
  const FreshSwipe({super.key});

  @override
  State<FreshSwipe> createState() => _FreshSwipeState();
}

class _FreshSwipeState extends State<FreshSwipe> {
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            TextButton(
              style: TextButton.styleFrom(
                  foregroundColor: Colors.white, backgroundColor: Colors.black, fixedSize: const Size(170, 40)),
